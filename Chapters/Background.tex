...
\autocite{aho2007compilers}. For instance, the regular expression \mintinline{text}{[a-zA-Z]+}
could be used to identify identifiers, while \mintinline{text}{[0-9]+} could be used to identify
integers.
...
\noindent where \mintinline{scala}{k} represents the continuation.
